...
function easyweb_webnus_setup_assets(){
...
add_action('wp_enqueue_scripts', 'easyweb_webnus_setup_assets');
function easyweb_webnus_setup_admin_assets(){
...
add_action('admin_enqueue_scripts','easyweb_webnus_setup_admin_assets');